...
class PostgresPromtPersistence(PromtPersistence):
    ...
    def update(self, old_name: str, name:str, descrition:str, creator:str,
                promt:str,create_time:str) -> Promt:
        ...
        promt_model.create_time = create_time
    ...
    def get_promt_by_id(self, promt_id:int) -> Promt:
